...
def build_research_report(rows: list[dict], strategy: str, strategy_params: dict, initial_capital: float, transaction_cost_bps: float, slippage_bps: float, include_ml: bool = False) -> dict:
